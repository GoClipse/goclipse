...
public class LaunchShortcut implements ILaunchShortcut {
   ...
   private void launch(String pName, String fName, String mode) {
		try {
			...
			ILaunchConfigurationType lct = lm.getLaunchConfigurationType(GoConstants.LAUNCH_CONFIGURATION_TYPE);
			...
			if (found == null) {
				...
				workingCopy.setAttribute(GoConstants.GO_CONF_ATTRIBUTE_BUILD_CONFIG,BuildConfiguration.RELEASE.toString());
