...
public class Tokenizer implements LexerListener {
	...
	private List<TokenUnit> tokenizedStream    = new ArrayList<TokenUnit>();
    ...
    */
	...
	/**
	 * @return the tokenizedStream
	 */
	public List<TokenUnit> getTokenizedStream() {
