 ...
 *******************************************************************************/
package com.googlecode.goclipse.editors.assist;
...
/**
 * Copied from org.eclipse.jface.text.AbstractInformationControl and modified for
 * new purpose.
 * @author steel
 */
public abstract class InformationControl implements IInformationControl, IInformationControlExtension, IInformationControlExtension3, IInformationControlExtension4, IInformationControlExtension5 {
    ...
    */
   public InformationControl(Shell parentShell, boolean isResizable) {
    ...
    */
   InformationControl(Shell parentShell, int shellStyle, final String statusFieldText, final ToolBarManager toolBarManager) {
