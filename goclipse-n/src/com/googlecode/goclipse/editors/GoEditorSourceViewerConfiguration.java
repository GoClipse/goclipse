...
public class GoEditorSourceViewerConfiguration extends TextSourceViewerConfiguration {
  ...
  public String[] getConfiguredContentTypes(ISourceViewer sourceViewer) {
    return new String[] {
        IDocument.DEFAULT_CONTENT_TYPE, PartitionScanner.COMMENT, PartitionScanner.STRING,
  ...
  public IPresentationReconciler getPresentationReconciler(ISourceViewer sourceViewer) {
    ...
    if (useHighlighting) {
      ...
      Color multilineStringColor = ColorManager.INSTANCE.getColor(PreferenceConverter.getColor(
          prefStore, PreferenceConstants.FIELD_SYNTAX_MULTILINE_STRING_COLOR));
      ...
      NonRuleBasedDamagerRepairer ndr = new NonRuleBasedDamagerRepairer(new TextAttribute(
          commentColor, null, commentStyle));
