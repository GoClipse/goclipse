...
public interface LaunchConstants_Actual {
	...
	public static final String ATTR_PROG_FILE = "MAIN_FILE";
	public static final String ATTR_PROG_ARGUMENTS = "PROGRAM_ARGS";
	public static final String ATTR_WORKING_DIRECTORY = "WORKING_DIRECTORY";
	public static final String ATTR_BUILD_CONFIG = "BUILD_CONFIG";
