...
public abstract class AbstractComponentsPrefPage extends AbstractLangPreferencesPage {
	...
	protected void createFileTextField(Composite parent, String label, String prefKey) {
		FileTextField pathField = new FileTextField(label);
		pathField.createComponentInlined(parent);
		addComponent(new StringFieldAdapter(prefKey, pathField));
	}
